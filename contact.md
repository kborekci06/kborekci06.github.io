...
<div class="section-divider"></div>
  ...
  <div class="contact-methods">
    <a href="mailto:kaan@borekci.com" class="contact-card">
    ...
    <a href="https://linkedin.com/in/kborekci" target="_blank" rel="noopener" class="contact-card">
      <div class="contact-icon">
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    <a href="https://github.com/kborekci06" target="_blank" rel="noopener" class="contact-card">
      <div class="contact-icon">
        <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  <div class="socials">
    ...
    <a class="social" href="mailto:kaan@borekci.com" aria-label="Email">
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path fill="currentColor" d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/>
      </svg>
    </a>
