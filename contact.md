...
<div class="socials" style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 20px; align-items: center;">
  
  <a class="social" href="https://github.com/kborekci06" target="_blank" rel="noopener" aria-label="GitHub" style="display: flex; align-items: center; text-decoration: none; color: inherit;">
  ...
  <a class="social" href="https://linkedin.com/in/kborekci" target="_blank" rel="noopener" aria-label="LinkedIn" style="display: flex; align-items: center; text-decoration: none; color: inherit;">
    <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
  ...
  <a class="social" href="mailto:kaan@borekci.com" aria-label="Contact" style="display: flex; align-items: center; text-decoration: none; color: inherit;">
    <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
    ...
    <span style="margin-left: 8px;">kaan@borekci.com</span>
  </a>
